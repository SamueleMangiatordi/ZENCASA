...
export const LeftSection = styled.div`
  ...
  gap: 10px; /* Aggiunge uno spazio uniforme tra gli elementi */
  ...
  text-align: center; /* Centra il testo degli elementi */
  height: 100%;
`;
...
export const RightSection = styled.div`
  ...
  justify-content: center; /* Centra verticalmente gli elementi */
  text-align: center; /* Centra il testo degli elementi */
  height: 100%; /* Assicura che il contenitore riempia lo spazio verticale disponibile */
`;
