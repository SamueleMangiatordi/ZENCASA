    ...
    <>
      ...
      >
        ...
        <textarea
          ...
          onChange={(e) =>
            setNewTicket({ ...newTicket, descrizione: e.target.value })
          }
      ...
      <div>
        {tickets.length === 0 ? (
          <p style={{ textAlign: 'center', color: '#666' }}>Nessun ticket aperto.</p>
        ) : (
          <table
            style={{
              width: '100%',
          ...
          >
            <thead>
              <tr style={{ backgroundColor: '#f5f5f5' }}>
                ...
                <th style={{ padding: '10px', borderBottom: '1px solid #ddd' }}>Descrizione</th>
  ...
  {tickets.map((ticket) => (
    <tr key={ticket.id}>
      ...
      <td style={{ padding: '10px', borderBottom: '1px solid #ddd' }}>
        {ticket.stato === 'Aperto' ? (
          <button
            onClick={() => handleChangeTicketStatus(ticket.id, 'Chiuso')}
            style={{
              padding: '5px 10px',
          ...
          <button
            onClick={() => handleChangeTicketStatus(ticket.id, 'Aperto')}
            style={{
              padding: '5px 10px',
              backgroundColor: '#28a745',
              color: '#fff',
